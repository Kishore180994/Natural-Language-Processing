...
public class NLP {
    ...
    private String show[] = {"show", "display","retrive", "get", "dikhao", "what"};
    private String noise1[] = {"data", "info", "information", "any", "all","to", "everything", "the"};
    private String where[] = {"where"};
    private String equals[] = {"equals", "contains", "equal"};
    private String is[] = {"is"};
    private String equals_is[] = {"equals", "contains"};
