...
public class Help extends Dialog {
  ...
  Help(Frame parent) {
    ...
    String str =
      "Help information\n" +
      "-----------------------\n\n" +
      "This human language parser used in this product\n" +
      ...
      "a few human language queries in the application's\n" +
      "text output area.\n\n" +
      "Type your human language queries in the input window\n" +
      "located just below the row of command buttons.\n" +
      "Your human language query will be converted to\n" +
